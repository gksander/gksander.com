...
![Home page with devtools network tab open, no JS files shown](@assets/posts/tight-with-astro/no-js.png)
...
![Open Graph image for this post](@assets/posts/tight-with-astro/dynamic-og.png)
